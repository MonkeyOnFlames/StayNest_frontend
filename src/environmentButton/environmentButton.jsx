    ...
    <div className="enivronment-container">
      {environmentFilters.map((environmentFilter) =>
        environmentFilter === "BIKE" ? (
          <button key={environmentFilter} className="env-button"> <img src={Images2} id="Bikeimg" alt="Bike logo" />
            Bike
          </button>
          ...
          <button key={environmentFilter} className="env-button"> <img src={Images4} id="KWTimg" alt="KWT logo" />
            Kwt
          </button>
        ) : environmentFilter === "RECYCLE" ? (
          <button key={environmentFilter} className="env-button"> <img src={Images} id="Recycleimg" alt="Recycle logo" />
            Recycle
          </button>
        ) : environmentFilter === "SOLAR_POWER" ? (
          <button key={environmentFilter} className="env-button"> <img src={Images5} id="SolarPowerimg" alt="SolarPower logo" />
            Solar power
          </button>
        ) : (
          ""
